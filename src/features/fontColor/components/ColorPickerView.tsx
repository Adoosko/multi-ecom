...
export const ColorPickerView: React.FC<ColorPickerViewProps> = ({ initialColor, onColorChange }) => {
  ...
  return (
    <div className="flex flex-col items-center p-2 space-y-3">
      ...
      <HexColorPicker color={pickerColor} onChange={handleColorChange} style={{ width: '100%', height: '150px' }}/>
...
import { translateColor } from "../utils/utils";

    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-6 text-white z-10">
        ...
        <div className="flex items-center text-sm font-medium opacity-90 group-hover:opacity-100 transition-opacity">
          ...
          <span className="ml-2 transform group-hover:translate-x-1.5 transition-transform duration-200 ease-in-out">
            →
          </span>{" "}
          {/* Výraznejší posun šípky */}
        </div>
      </div>
    </Link>
  );

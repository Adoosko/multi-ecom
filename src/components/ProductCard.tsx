...
import type { Manufacturer, Media, Product } from "@/payload-types"; // Importuj správne typy
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative w-full  aspect-[4/3] bg-muted/50">
          {" "}
          {/* Pomer strán 4:3, fallback pozadie */}
          <Image
      ...
      <div className="p-3 sm:p-4 space-y-1">
        ...
        {/* DPH Text */}
        <p className="text-[11px] text-muted-foreground/80 !mt-0">
          {" "}
          {/* Menší text, odstránená horná medzera */}
          Cena s DPH
        </p>
      </div>
    </Link>

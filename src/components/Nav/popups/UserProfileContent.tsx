...
import {
  LogIn, // Ikona pre objednávky
  LogOut, // Ikona pre účet
  Package,
  UserCircle, // Ikona pre prihlásenie
...
const UserProfileContent: React.FC<UserProfileContentProps> = ({
  ...
  return (
    ...
    <div className="bg-popover text-popover-foreground h-full flex flex-col p-0">
      {" "}
      {/* Padding riešime vnútri */}
        ...
        {isUserLoggedIn ? (
          ...
          <div className="flex flex-col items-center text-center space-y-4 pt-4">
            ...
            <Button
              asChild
              size="lg"
              className="w-full h-11 bg-primary text-primary-foreground hover:bg-primary/90 dark:bg-red-700 dark:hover:bg-red-800 dark:text-white"
            >
